...
import { ArrowLeft, MoreHorizontal, Play, CheckCircle, Heart, MessageCircle, Eye, Bookmark, Activity } from 'lucide-react';
...
const WorkoutActivityPage = () => {
  ...
  const [videoData, setVideoData] = useState({
    ...
    description: 'High-intensity training to boost metabolism and build strength',
    stats: {
      views: 32450,
      likes: 1240,
      comments: 186
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-gradient-to-br from-purple-500 to-purple-800 p-4 pb-8 text-white rounded-b-3xl shadow-lg relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center mb-6">
            ...
            <div className="ml-2">
              <p className="text-purple-100 text-sm font-medium tracking-wider uppercase">Daily Workout</p>
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight">Physical Activity</h1>
            </div>
          </div>
      ...
      <div className="p-4 md:p-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <button className="text-purple-600 text-sm font-medium hover:text-purple-700">View History</button>
        </div>
            ...
            >
              ...
              <div className="flex-1 bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                <div className="flex items-center justify-between mb-2">
                  <div>
                    <h3 className="font-semibold text-lg text-gray-900">{item.activity}</h3>
